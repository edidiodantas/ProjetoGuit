...
import OnlineProfileLoader from "./profile/OnlineProfileLoader.js";
...
export class ConfigHandler {
  ...
  constructor(
    ...
    const onlineProfileLoader = new OnlineProfileLoader(
      ide,
      ideSettingsPromise,
      controlPlaneClient,
      writeLog,
    ...
    this.profiles = [
      new ProfileLifecycleManager(localProfileLoader),
      new ProfileLifecycleManager(onlineProfileLoader),
    ];
    ...
    this.controlPlaneClient.listWorkspaces().then(async (workspaces) => {
      this.profiles = this.profiles.filter(
        (profile) =>
          ...
          profile.profileId === FURYU_ONLINE_PROFILE_ID,
      );
